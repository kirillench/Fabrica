...
ЯЗЫК: все тексты — строго на русском, грамотным научно-техническим языком.
Латиница допустима ТОЛЬКО в химических символах и формулах (Nb, NbC, pH, Cu).
Термины пиши по-русски: «пирротиновый», а не «pyrrhotitic»; «флотация», а не
«flotation». Перед выдачей проверь орфографию терминов."""
